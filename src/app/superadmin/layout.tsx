...
import { Settings, Users, Building, CreditCard, ChevronLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col hidden md:flex">
        ...
        <div className="p-4 border-t border-slate-800 space-y-2">
          ...
          <SignOutButton className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-red-900/50 text-red-400 hover:text-red-300 transition-colors w-full text-left" />
        </div>
      </aside>
