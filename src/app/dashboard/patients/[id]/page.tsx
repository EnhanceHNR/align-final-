      ...
      <div className="mx-auto max-w-5xl space-y-6">
        {anamnesis?.allergiesFlag && (
          <div className="rounded-2xl border border-red-200 bg-red-50 p-4 shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="font-semibold text-red-700">Allergy warning</h2>
        ...
        {activeTab === "overview" && (
          <>
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-500">Patient profile</p>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3 md:mt-0">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 rounded-xl bg-teal-600 px-4 py-2 font-medium text-white transition hover:bg-teal-700"
                  >
                    🦷 View Odontogram
                  </Link>
                  ...
                  <Link
                    ...
                    className="flex items-center rounded-xl bg-green-600 px-4 py-2 font-medium text-white transition hover:bg-green-700"
                  >
                    💳 New Invoice
                  </Link>
                  ...
                  <Link
                    ...
                    className="flex items-center rounded-xl bg-blue-600 px-4 py-2 font-medium text-white transition hover:bg-blue-700"
                  >
                    Edit patient
                  </Link>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    ...
                    patient.employmentStatus === "Employed"
                      ? "Employed"
                      : patient.employmentStatus === "Nezaposlen" ||
                          patient.employmentStatus === "Unemployed"
                        ? "Unemployed"
            ...
            <div className="rounded-3xl bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-semibold">Visit notes</h2>

              <textarea
                value={visitNote}
                onChange={(e) => setVisitNote(e.target.value)}
                placeholder="Add note..."
                className="w-full rounded-xl border border-gray-200 p-3 transition outline-none focus:ring-2 focus:ring-blue-400"
                rows={4}
              />
