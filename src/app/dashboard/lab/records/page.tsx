import { fetchSubmissions, fetchEntitiesAction } from "../actions";
import { RecordsClientPage } from "@/components/lab/records/RecordsClientPage";
...
export default async function RecordsPage(props: Props) {
