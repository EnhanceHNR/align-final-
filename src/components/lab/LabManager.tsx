...
import { fetchEntitiesAction, addEntityAction, deleteEntityAction, updateEntityAction } from "@/app/dashboard/lab/actions";
...
export function LabManager() {
  ...
  const description = "Manage receiving labs, partners, and internal staff.";
