...
import { CalendarIcon, ChevronLeft, ArrowRight, UserCheck, Clock } from "lucide-react";
  ...
  try {
                ...
                {appointments.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {appointments.map((app, idx) => {
                            ...
                            return (
                                <Link href={`/records`} key={idx} className="block group">
    ...
    return (
      <div className="p-10 bg-red-100 text-red-900 border border-red-500 rounded-xl m-10">
        <h2 className="text-xl font-bold">AppointmentsPage SSR Error</h2>
