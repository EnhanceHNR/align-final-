...
import { updateSubmissionRemarksAction, deleteSubmissionAction, editSubmissionAction } from '@/app/actions';
                                                                        ...
                                                                        <div className="space-y-6">
                                                                            ...
                                                                            <div className="space-y-4">
                                                                                ...
                                                                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                                                                    ...
                                                                                    {(!trailItem.photoUrls || trailItem.photoUrls.length === 0) && (
